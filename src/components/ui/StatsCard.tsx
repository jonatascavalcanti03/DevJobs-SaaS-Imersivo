  ...
  return (
    ...
    >
      <div className="flex items-start justify-between mb-3">
        <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-[#6366F1]/20 to-[#6366F1]/5 border border-[#6366F1]/20 flex items-center justify-center group-hover:from-[#06B6D4]/20 group-hover:to-[#06B6D4]/5 group-hover:border-[#06B6D4]/20 transition-all duration-500">
