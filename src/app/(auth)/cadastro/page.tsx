...
import { Mail, Lock, User, Building2, Link as LinkIcon, Users, CheckCircle2, ArrowRight } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-[#94A3B8] text-sm">Junte-se à maior plataforma tech do Brasil</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        <AnimatePresence mode="wait">
          {role === "CANDIDATE" ? (
            ...
            >
              ...
              <div>
                <label className="block text-sm font-medium text-[#94A3B8] mb-1.5 ml-1">Senha</label>
                <div className="relative group">
                  <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                ...
                {candPassword.length > 0 && (
                  <div className="mt-2 flex gap-1 h-1.5">
                    ...
                    <div className={`flex-1 rounded-full ${candPassword.length >= 8 ? "bg-emerald-500" : "bg-white/10"}`} />
                  </div>
                )}
              </div>
            </motion.div>
            ...
            >
              ...
              <div>
                <label className="block text-sm font-medium text-[#94A3B8] mb-1.5 ml-1">Email Corporativo</label>
                <div className="relative group">
                  <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                    <Mail className="h-5 w-5 text-[#64748B] group-focus-within:text-[#6366F1] transition-colors" />
                  </div>
        ...
        <label className="flex items-start gap-3 cursor-pointer group mt-6">
          ...
          <span className="text-sm text-[#94A3B8] group-hover:text-white transition-colors">
            Li e concordo com os <a href="#" className="text-[#6366F1] hover:underline">Termos de Uso</a> e a <a href="#" className="text-[#6366F1] hover:underline">Política de Privacidade</a>, autorizando o tratamento dos meus dados conforme a LGPD.
          </span>
        </label>
      ...
      <p className="mt-8 text-center text-sm text-[#94A3B8]">
        Já tem uma conta?{" "}
        <a href="/login" className="text-white font-medium hover:text-[#06B6D4] transition-colors">
          Faça login
        </a>
      </p>
    </motion.div>
