    ...
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div className="space-y-6">
        ...
        <div className="glass-card rounded-3xl p-6 sm:p-8 space-y-6">
          <h2 className="text-xl font-bold text-white border-b border-white/10 pb-4">Identidade da Empresa</h2>
          
          <div className="flex flex-col sm:flex-row gap-6 items-start sm:items-center">
            <div 
              className="w-24 h-24 rounded-2xl bg-gradient-to-br from-[#06B6D4]/30 to-[#6366F1]/30 border-2 border-white/10 flex items-center justify-center text-white font-bold text-2xl flex-shrink-0 cursor-pointer hover:border-[#06B6D4]/50 transition-colors overflow-hidden"
              onClick={() => imageInputRef.current?.click()}
            >
              {image ? (
                <img src={image} alt="Logo da Empresa" className="w-full h-full object-cover" />
              ) : (
                companyName ? companyName.charAt(0).toUpperCase() : <Building2 className="w-8 h-8 text-white/50" />
              )}
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 pt-4">
            <div>
              <label className="block text-sm font-medium text-[#94A3B8] mb-1.5 ml-1">Nome da Empresa</label>
            ...
            <div>
              <label className="block text-sm font-medium text-[#94A3B8] mb-1.5 ml-1">Website Oficial</label>
              <div className="relative group">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
          ...
          <div>
            <label className="block text-sm font-medium text-[#94A3B8] mb-1.5 ml-1">Tamanho da Empresa</label>
            <div className="relative group">
              <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
              ...
              <select
                ...
                className="block w-full pl-11 pr-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white focus:bg-white/10 focus:border-[#06B6D4]/50 focus:ring-1 focus:ring-[#06B6D4]/50 transition-all outline-none appearance-none"
              >
          ...
          <div>
            <label className="block text-sm font-medium text-[#94A3B8] mb-1.5 ml-1">Sobre a Empresa</label>
            <textarea
              rows={4}
              value={companyAbout}
              onChange={(e) => setCompanyAbout(e.target.value)}
              placeholder="Descreva a missão, visão, cultura e o que a empresa faz..."
              className="block w-full p-4 bg-white/5 border border-white/10 rounded-xl text-white placeholder-[#64748B] focus:bg-white/10 focus:border-[#06B6D4]/50 focus:ring-1 focus:ring-[#06B6D4]/50 transition-all outline-none resize-none"
            />
          </div>
        </div>
        ...
        <div className="glass-card rounded-3xl p-6 sm:p-8 space-y-6">
          <h2 className="text-xl font-bold text-white border-b border-white/10 pb-4">Dados do Representante (Conta)</h2>
          
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 pt-4">
            <div>
              <label className="block text-sm font-medium text-[#94A3B8] mb-1.5 ml-1">Seu Nome</label>
              <div className="relative group">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
            ...
            <div>
              <label className="block text-sm font-medium text-[#94A3B8] mb-1.5 ml-1">Email de Acesso</label>
              <div className="relative group">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
